...
request review issue only after the golden-query gate passes. A maintainer uses
its compare link to create the PR. The workflow never pushes generated data
